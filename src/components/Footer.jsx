...
const Footer = () => {
  ...
  // If we are on login or register, don't render anything
  if (shouldHideFooter) {
    return null;
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="#" className="hover:text-white transition">Scheduling</Link></li>
              <li><Link to="#" className="hover:text-white transition">Workspaces</Link></li>
              <li><Link to="#" className="hover:text-white transition">Client Management</Link></li>
              <li><Link to="#" className="hover:text-white transition">Analytics</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="#" className="hover:text-white">Doctors</Link></li>
              <li><Link to="#" className="hover:text-white">Freelancers</Link></li>
              <li><Link to="#" className="hover:text-white">Consultants</Link></li>
